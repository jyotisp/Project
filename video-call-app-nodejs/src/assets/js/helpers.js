export default {
    ...
    renderNotes() {
        ...
        notesObj.forEach((el, index) => {
            ...
            html += `
            <div class="noteCard card my-1" >
               <div class="card-body" style="font-size:small" >
                  <p class="card-title">${el.roomName}</p>
                  <p class="card-text">${el.dateInput}</p>
        ...
        if (notesObj.length != 0) {
            document.querySelector('#schedule-notes').innerHTML = html;
        } else {
    ...
    getIceServer() {
        return {
            iceServers: [
                ...
                {
                    username: "p1wvVHU4Sdt11kACmxOlZiBDOCQS7cVOXW_ou7gcnmuPCvMKZRmZ1qk1w4cP0G6HAAAAAF-zkBJKeW90aXNw",
                    credential: "aeb7e96a-28b2-11eb-9247-0242ac140004",
                    urls: [
